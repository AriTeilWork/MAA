...
/**
 * Слой доступа к данным: скрывает Room/DAO от UI. Один экземпляр можно создавать в каждой Activity.
 */
public class MeetingManager {
    ...
    /**
     * Поиск по нескольким полям; пустые строки не фильтруют.
     */
    ...
    /**
     * Убирает дубликаты при объединении нескольких выборок (если понадобится).
     */
