...
public interface MeetingDao {
    ...
    @Query("SELECT DISTINCT place FROM meetings WHERE place IS NOT NULL AND place != '' ORDER BY place ASC")
    List<String> getUniquePlaces();

    @Query("SELECT participants FROM meetings")
    List<String> getAllParticipantsRaw();
